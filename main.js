...
$(document).ready(function () {
    ...
    $('.swiper-slide').click(function (e) {
        ...
        if ($target.hasClass('BraveBear')) {
            ...
            $(".popup-urlhref").attr("href", "https://github.com/HarshithMulakala/BackOnTrack");
            $('.popup-img').css("visibility", "visible");
            $('.popup-img').css("opacity", "1");
            $(".popup-img").attr("src", "./BraveBear.png");
        }
        if ($target.hasClass('BulletBounce')) {
        ...
        if ($target.hasClass('Cashonomics')) {
        ...
        if ($target.hasClass('Speakl')) {
            $(".popup-container h3").text("Speakl");
            $(".popup-container p").text("Speakl is a real-time, AI-powered speaking coach for interviews and more. It listens, analyzes delivery, and provides instant feedback on pacing, clarity, filler words, and confidence so you can practice and improve faster.");
            $(".popup-urlhref").attr("href", "https://speakl.ai");
            $('.popup-img').css("visibility", "visible");
            $('.popup-img').css("opacity", "1");
            $(".popup-img").attr("src", "./SpeaklLogo.png");
        }
        if ($target.hasClass('PlayAI')) {
            $(".popup-container h3").text("PlayAI");
            $(".popup-container p").text("PlayAI is a CLI prompt-to-2D Unity game tool. Describe a simple game in natural language and generate a playable 2D prototype with scaffolded scenes, prefabs, and scripts to accelerate experimentation.");
            $(".popup-urlhref").attr("href", "https://github.com/HarshithMulakala/PlayAI");
            $('.popup-img').css("visibility", "visible");
            $('.popup-img').css("opacity", "1");
            $(".popup-img").attr("src", "./playai.jpg");
        }
        if ($target.hasClass('CurryCal')) {
            $(".popup-container h3").text("CurryCal");
            $(".popup-container p").text("CurryCal is a South Asian calorie tracking app that can count calories from photos. Snap a picture of your meal and get instant estimates tailored to regional dishes, making healthy tracking effortless.");
            $(".popup-urlhref").attr("href", "https://github.com/HarshithMulakala/CuryCalAI");
            $('.popup-img').css("visibility", "visible");
            $('.popup-img').css("opacity", "1");
            $(".popup-img").attr("src", "./currycal.png");
        }
        if ($target.hasClass('CashonomicsWork')) {
        ...
        if ($target.hasClass('DonkeyClick')) {
